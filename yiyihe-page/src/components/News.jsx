...
const newsData = [
	{
		...
		date: '2025/04/03',
		description: 'Staff AI research scientist Hongxu Ma from Google DeepMind delivered a guest lecture on "The Rise of the Data Science Assistant: LLM Agents in Action".',
