...
const newsData = [
...

	{
		...
		date: '2025/04/04',
		description: 'Tara is accepted into the AI Safety Initiative (AISI) research program at Georgia Tech, where she is contributing to a research paper on AI interpretability.',
...

	{
		...
		date: '2025/04/01',
		description: 'Tara is recognized as one of 2025 Lavender Celebration graduates.',
...

	{
		...
		date: '2025/02/19',
		description: 'Yiyi appointed as faculty fellow to the Brook Byers Institute for Sustainable Systems (BBISS).',
...

	{
		...
		date: '2025/02/01',
		description: 'Tara is selected as one of seven AI Safety Fellows by AISI, a Georgia Tech community dedicated to ensuring that AI is developed for the benefit of the future.',
		link: 'https://www.aisi.dev/'
	},

	{
		...
		date: '2024/12/24',
		description: 'Yiyi joined a Stanford-led team awarded a grant from the Stanford Sustainability Accelerator for their proposal, "Harnessing the Data Revolution to Mitigate Flood Impacts on Vulnerable Communities in Sub-Saharan Africa."',
